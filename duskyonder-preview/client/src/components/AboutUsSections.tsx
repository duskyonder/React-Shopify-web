    ...
    <section className="au2-cta" ref={ref}>
      <div className={`au2-cta-inner ${visible ? "au2-visible" : ""}`}>
        ...
        <div className="au2-cta-btns">
          {au.ctaPrimaryLabel && (
            <a href={au.ctaPrimaryLink} className="au2-btn au2-btn-white">{au.ctaPrimaryLabel}</a>
          )}
          {au.ctaSecondaryLabel && (
            <a href={au.ctaSecondaryLink} className="au2-btn au2-btn-outline">{au.ctaSecondaryLabel}</a>
          )}
        </div>
      </div>
    </section>
