...
export function PlatformBadge({ platform }: { platform: string }) {
  ...
  const p = map[platform] ?? {
    label: platform.toUpperCase().slice(0, 2),
    color: "#888",
  };
  return (
    <span className="inf-platform-badge" style={{ background: p.color }}>
      {p.label}
    </span>
  );
}
        ...
        >
          ...
          >
            {creator.shopProductImageUrl ? (
              <img
                src={creator.shopProductImageUrl}
                alt={creator.shopProductName}
                style={{
                  width: "100%",
                  height: "100%",
                  objectFit: "cover",
              ...
              <div
                style={{
                  ...
                  height: "100%",
                  background:
                    "linear-gradient(135deg, #c8ddd5 0%, #EAF2EE 100%)",
                }}
              />
            )}
          </div>
    ...
    >
      ...
      >
        ...
        >
          {creator.shopProductImageUrl ? (
            ...
            <div
              style={{
                width: "100%",
                height: "100%",
                background: "linear-gradient(135deg, #c8ddd5 0%, #EAF2EE 100%)",
              }}
            />
          )}
          ...
          >
            <div
              className="sf-video-creator-avatar sf-video-creator-avatar--placeholder"
              style={{
                width: 28,
                height: 28,
                borderRadius: "50%",
            ...
            >
              <div
                style={{
                  ...
                  height: "100%",
                  background:
                    "linear-gradient(135deg, #EAF2EE 0%, #d4e8e0 100%)",
                }}
              />
            </div>
          </div>
  ...
  return (
    <div className="inf-creator-card">
      ...
      <a
        href={
          creator.handle
            ? `/pages/influencer/${creator.handle.replace("@", "")}`
            : undefined
        }
      ...
      >
        <div className="inf-creator-cover" style={{ aspectRatio: imgRatio }}>
          ...
          {creator.videoUrl && videoPlaying && (
            <div
              className="inf-creator-video-wrap"
              onClick={e => e.stopPropagation()}
            >
              {creator.videoUrl.includes("youtube") ||
              creator.videoUrl.includes("youtu.be") ? (
                <iframe
          ...
          <div className="inf-creator-cover-overlay">
            <div className="inf-creator-cover-name" style={ts("creatorName")}>
              {creator.name}
            </div>
            <div
              className="inf-creator-cover-handle"
              style={ts("creatorHandle")}
            >
              {creator.handle}
            </div>
          </div>
