        ...
        >
          ...
          >
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: 16 }}>
              {filesError ? (
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: 200, color: "#c0392b", gap: 12 }}>
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                    <circle cx="12" cy="12" r="10" />
                    <line x1="12" y1="8" x2="12" y2="12" />
                    <line x1="12" y1="16" x2="12.01" y2="16" />
                  </svg>
                  <span style={{ fontSize: "0.9rem", textAlign: "center", maxWidth: 320 }}>
                    {(filesErrorObj as any)?.message || "Failed to load Shopify Files"}
                  </span>
                  <button
                    onClick={() => refetchFiles()}
                    style={{ padding: "6px 16px", background: "#0D3D2B", color: "#fff", border: "none", borderRadius: 6, cursor: "pointer", fontSize: "0.85rem" }}
                  >
                    Retry
                  </button>
                </div>
