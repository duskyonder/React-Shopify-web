  ...
  const content = (
    <div className="sf-nl-modal" style={{ background: bgColor }}>
      ...
      {imageUrl ? (
        ...
        <div
          className="sf-nl-image-panel sf-nl-image-panel--placeholder"
          style={{
        ...
        >
          ...
          >
            ...
            >
              <path
                d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"
                fill="currentColor"
              />
            </svg>
            <span
      ...
      <div className="sf-nl-content-panel">
        ...
        <div
          ...
          style={{
            ...
            borderColor: isDark ? "rgba(255,255,255,0.2)" : "#175C40",
          }}
        >
          DUSKYONDER
        </div>
        ...
        {submitted ? (
          <div
            ...
            style={{ color: isDark ? "#7ECBA8" : "#175C40" }}
          >
            <svg
              width="20"
              height="20"
