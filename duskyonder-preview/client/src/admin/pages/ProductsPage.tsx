...
function FeaturedInstanceEditor({ instance }: { instance: FeaturedInstance }) {
  ...
  const handleRemoveProduct = (productId: string) => {
    updateFeaturedInstance(instance.id, {
        ...
        <div className="flex items-center gap-2">
          <CardTitle className="text-sm flex-1">
            <Input
              ...
              onChange={e =>
                updateFeaturedInstance(instance.id, { title: e.target.value })
              }
              placeholder="板块标题"
      ...
      <CardContent className="px-4 pb-4 space-y-3">
            ...
            <>
              ...
              <div className="space-y-1.5 flex-1">
                ...
                <Input
                  value={instance.tag ?? ""}
                  onChange={e =>
                    updateFeaturedInstance(instance.id, { tag: e.target.value })
                  }
        ...
        <div className="flex gap-4 items-end">
          ...
          <div className="space-y-1.5 flex-1">
            ...
            <Input
              ...
              onChange={e =>
                updateFeaturedInstance(instance.id, {
                  productAspectRatio: e.target.value,
                })
              }
              placeholder="3/4"
              className="h-8"
        ...
        {instance.dataSource === "auto" && (
          <div className="text-center py-4 text-muted-foreground text-sm border rounded-lg border-dashed bg-muted/30">
            ...
            {instance.collectionHandle && (
              <span className="block mt-1">
                Collection: <strong>{instance.collectionHandle}</strong>
              </span>
            )}
          </div>
        )}
