...
const defaultAboutUsConfig: AboutUsConfig = {
  ...
  heroSubtitle: "Athleisure that moves with your life.",
  heroEst: "Est. 2025",
  heroBgUrl: "",
  storyTag: "Our Story",
  storyTitle: "From Dawn to Dusk, Designed for Her.",
  storyParagraphs: [
    "Founded in 2025, Dusk Yonder was created to blur the boundaries between daily life, work, and movement. We believe that athleisure should not be limited to the gym—it should be a seamless part of your daily rhythm.",
  ...
  principles: [
    ...
    { id: "p2", number: "02", title: "Community", subtitle: "Built for the Modern Woman", body: "We are built for the modern woman who values both performance and style. We design with the understanding that our community moves fluidly between professional responsibilities and personal well-being." },
  ...
  philosophyTitle: "Performance Meets Versatility.",
  philosophyBody: "True quality is defined by structural integrity—from the weight of the fabric to the precision of the fit. We focus on high-performance materials designed for versatility, ensuring our apparel remains comfortable and functional throughout your day.",
  philosophyPoints: [
    "High-stretch, durable fabrics for all-day wear.",
  ...
  stats: [
    ...
    { id: "s2", value: "50+", label: "SKUs Live" },
    { id: "s3", value: "10,000+", label: "Global Customers" },
    { id: "s4", value: "4.8 ★", label: "Avg. Product Rating" },
  ],
  ...
  universeCards: [
    ...
    { id: "u2", number: "02", module: "Community", title: "Movement as a Lifestyle", body: "We connect with a community that values movement as a lifestyle, fostering a shared commitment to health and balanced living." },
  ...
  ctaTitle: "This Is Your Invitation.",
  ctaSubtitle: "Whether you're stepping onto the yoga mat for the first time or preparing for your next challenge—there is a place for you here.",
  ctaPrimaryLabel: "Shop New Arrivals",
  ctaPrimaryLink: "/collections/new",
  ctaSecondaryLabel: "Join the Community",
